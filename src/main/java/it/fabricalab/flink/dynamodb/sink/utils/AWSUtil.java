...
package it.fabricalab.flink.dynamodb.sink.utils;

/************************************************
 * Copiato e poi modificato da
 * flink-connector-kinesis
 * src/main/java/org/apache/flink/streaming/connectors/kinesis/util/AWSUtils.java
 */
...
public class AWSUtil {
	 ...
	 */
	public static AmazonDynamoDB createDynamoDBClient(Properties configProps) {
		return createDynamoDBClient(configProps, new ClientConfigurationFactory().getConfig());
	}
	 ...
	 */
	public static AmazonDynamoDB createDynamoDBClient(Properties configProps, ClientConfiguration awsClientConfig) {
		...
		if (configProps.containsKey(AWSConfigConstants.AWS_ENDPOINT)) {
			// Set signingRegion as null, to facilitate mocking DynamoDB for local tests
